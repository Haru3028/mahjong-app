    ...
    <div className="min-h-screen flex flex-col items-center justify-center calculator-page-main p-8">
      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <Link href="/yakuhyo" legacyBehavior>
          <a className="base-button text-center w-full">計算役表示</a>
        </Link>
        {/* 計算練習 ボタン */}
        <Link href="/keisanrenshu" legacyBehavior>
          <a className="base-button text-center w-full">計算練習</a>
        </Link>
        {/* 何切る問題 ボタン */}
        <Link href="/nanikiru" legacyBehavior>
          <a className="base-button text-center w-full">何切る問題</a>
        </Link>
        {/* 履歴 ボタン */}
        <Link href="/history" legacyBehavior>
          <a className="base-button text-center w-full">履歴</a>
        </Link>
        {/* 一覧 ボタン */}
        <Link href="/list" legacyBehavior>
          <a className="base-button text-center w-full">一覧</a>
        </Link>
      </div>
    </div>
  );
